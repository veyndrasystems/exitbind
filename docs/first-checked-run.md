...
In `v0.25.0-rc.2`, new checked runs use run-event format 8. Exitbind binds each submission, check,
...
For the `v0.25.0-rc.2` release candidate, `run observe-check` can execute only the frozen
