...
In `v0.23.1-rc.1`, new checked runs use run-event format 6. Exitbind binds each submission, check,
...
For the `v0.23.1-rc.1` release candidate, `run observe-check` can execute only the frozen
