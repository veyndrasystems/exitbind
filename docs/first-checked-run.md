...
In `v0.24.0-rc.7`, new checked runs use run-event format 8. Exitbind binds each submission, check,
...
For the `v0.24.0-rc.7` release candidate, `run observe-check` can execute only the frozen
