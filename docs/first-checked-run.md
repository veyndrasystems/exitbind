...
In `v0.21.0`, new checked runs use run-event format 6. Exitbind binds each submission, check,
...
For the stable `v0.21.0` release, `run observe-check` can execute only the frozen
