...
In the stable `v0.20.0` release, `run observe-check` executes only the frozen command
...
run; v3 supports caller-reported `run record-check` only. The stable `v0.20.0`
