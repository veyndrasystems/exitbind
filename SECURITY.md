...
In the `v0.23.1-rc.2` release candidate, `run observe-check` executes only the frozen command
...
run; v3 supports caller-reported `run record-check` only. The `v0.23.1-rc.2` release candidate
