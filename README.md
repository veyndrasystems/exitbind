...
Current prerelease: `v0.24.0-rc.2`. One local binary; it calls no model and runs
...
This page describes the opt-in release candidate `v0.24.0-rc.2` for Linux x86_64
...
```sh
# Codex
codex plugin marketplace add veyndrasystems/exitbind --ref v0.24.0-rc.2
...
The Codex command pins `v0.24.0-rc.2`; Claude Code follows the repository's current
