...
Current prerelease: `v0.24.0-rc.5`. One local binary; it calls no model and runs
...
This page describes the opt-in release candidate `v0.24.0-rc.5` for Linux x86_64
...
```sh
# Codex
codex plugin marketplace add veyndrasystems/exitbind --ref v0.24.0-rc.5
...
The Codex command pins `v0.24.0-rc.5`; Claude Code follows the repository's current
